...
export const russianPrefixes = [
  'R', 'U',           // Основные российские префиксы
  'RA', 'RK', 'RN',   // Любительские
  'RW', 'RZ',         // Дополнительные
  'UA', 'UB', 'UC', 'UD', 'UE', 'UF', 'UG', 'UH', 'UI' // Региональные U-префиксы
];
...
export function generateRussianCallsign(format = '2x2') {
  const prefix = russianPrefixes[Math.floor(Math.random() * russianPrefixes.length)];
