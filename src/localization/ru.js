...
export const ru = {
  ...
  scoreboard: {
    ...
    total: 'Итоговый счёт (Verified)',
    raw: 'Raw',
    accuracy: 'Точность',
    mistakes: 'Ошибки',
    dupes: 'Дубли',
    // 🆕 Подсказки при наведении на бейджи кодов ошибок в логе.
    // DUP/NIL/RST/NR — из Readme.txt MorseRunner, EXCH — наше
    // расширение под нечисловые поля обмена (см. verification.js)
    codes: {
      DUP: 'Дубль — такой позывной уже отработан',
      NIL: 'Позывной не совпал с тем, что передала станция',
      RST: 'Неверно принят RST',
      NR: 'Неверно принят номер обмена',
      EXCH: 'Неверно принято поле обмена (имя/область/район/парк)',
    },
  },
