...
class LocalizationManager {
  ...
  qrnLabels.forEach((label) => {
    if (label.textContent.includes('QRN') || label.textContent.includes('Atmospheric')) {
  ...
  callsignFormatLabels.forEach((label) => {
    if (label.textContent.includes('Callsign Format') || label.textContent.includes('Формат позывных')) {
